...
class Robot:
    ...
    def __init__(self, radius, max_v, camera_sensor_range, local_comms_range, place_tol=None, abandon_tol=None, pre_place_delta=None, lifter_state=1): 
        ...
        self.local_comms_range = local_comms_range
        self.place_tol = place_tol
        self.abandon_tol = abandon_tol
        self.lifter_state = lifter_state
        self.pre_place_delta = pre_place_delta
    
    def setup_bb(self, width, height, heading_change_rate, repulsion_o, repulsion_w, task_log, use_global, local_comms, latency, drop_out_rate, carry_count = []):
        ...
        self.blackboard.register_key(key="local_comms_range", access=py_trees.common.Access.WRITE)
        ...
        self.blackboard.register_key(key="local_comms", access=py_trees.common.Access.WRITE)
        ...
        self.blackboard.local_comms_range = self.local_comms_range
        ...
        self.blackboard.use_global = use_global
        self.blackboard.local_comms = local_comms
        self.blackboard.buffer_send = [0]*latency
        self.blackboard.buffer_recv = [0]*latency
        self.blackboard.drop_out_rate = drop_out_rate
...
class Swarm:
    ...
    def add_agents(self, agent_obj, number, width, height, bt_controller, task_log=None, use_global=False, local_comms=False, latency=0, drop_out_rate=0.0, carry_count = None):
        ...
        for ag in self.agents:
            ...
            ag.setup_bb(width, height, self.heading_change_rate, self.repulsion_o, self.repulsion_w, task_log, use_global, local_comms, latency, drop_out_rate, carry_count)
