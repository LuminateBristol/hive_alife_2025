...
class Simulator:
    ...
    def build_swarm(self, cfg):
        robot_obj = Robot(
            ...
            local_comms_range=cfg.get('local_comms_range'),
        ...
        # NOTE: if running with faults - change this initialisation from Swarm to FaultySwarm class from faults_archive.py
        swarm = Swarm(
        ...
        swarm.add_agents(robot_obj, cfg.get('warehouse', 'number_of_agents'),
                         ...
                         use_global=self.cfg.get('use_global'),
                         local_comms=self.cfg.get('local_comms'),
                         latency=self.cfg.get('latency'),
                         drop_out_rate=self.cfg.get('drop_out_rate'),
