...
class Robot:
    ...
    def add_observations(self):
        ...
        self.observation_space.append([f'robot_{self.robot_index}', f'robot_{self.robot_index}_chosen_door',   'has_status',   {'type':'chosen_door',           'weight':0, 'robot_name':f'robot_{self.robot_index}',  'data':0,                           'time':0} ])
        self.observation_space.append([f'robot_{self.robot_index}', f'robot_{self.robot_index}_waypoint',      'in_progress',  {'type':'waypoint',              'weight':0, 'robot_name':f'robot_{self.robot_index}',  'data':0,                           'time':0} ])
