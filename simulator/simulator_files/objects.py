...
class Robot:
    ...
    def add_observations(self):
        ...
        """
        self.observation_space.append([f'robot_{self.robot_index}', f'robot_{self.robot_index}_position',      'has_status',   {'type':'robot_position',        'robot_name':f'robot_{self.robot_index}',  'data':np.array([999, 999, 999]),   'weight':1, 'time':0} ])
        self.observation_space.append([f'robot_{self.robot_index}', f'robot_{self.robot_index}_led_status',    'has_status',   {'type':'robot_led_status',      'robot_name':f'robot_{self.robot_index}',  'data':[],                          'weight':0, 'time':0} ])
        self.observation_space.append([f'robot_{self.robot_index}', f'robot_{self.robot_index}_lifter_status', 'has_status',   {'type':'robot_lifter_status',   'robot_name':f'robot_{self.robot_index}',  'data':False,                       'weight':0, 'time':0} ])
        self.observation_space.append([f'robot_{self.robot_index}', f'robot_{self.robot_index}_heading',       'has_status',   {'type':'robot_heading',         'robot_name':f'robot_{self.robot_index}',  'data':0,                           'weight':1, 'time':0} ])
        self.observation_space.append([f'robot_{self.robot_index}', f'robot_{self.robot_index}_speed',         'has_status',   {'type':'robot_speed_status',    'robot_name':f'robot_{self.robot_index}',  'data':0,                           'weight':0, 'time':0} ])
        self.observation_space.append([f'robot_{self.robot_index}', f'robot_{self.robot_index}_task_id',       'in_progress',  {'type':'robot_task_id',         'robot_name':f'robot_{self.robot_index}',  'data':0,                           'weight':0, 'time':0} ])
        self.observation_space.append([f'robot_{self.robot_index}', f'robot_{self.robot_index}_pheromone_map', 'has_status',   {'type':'robot_pheromone_map',   'robot_name':f'robot_{self.robot_index}',  'data':0,                           'weight':0, 'time':0} ])
