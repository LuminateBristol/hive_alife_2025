...
class VizSim(Simulator):
    ...
    def iterate(self, frame, dot=None, box=None, h_line=None, fault_c=None, cam_range=None, snapshot=False):
        ...
        dot, box, h_line, cam_range = self.animate(frame, counter, dot, box, h_line, fault_c, cam_range)
        if snapshot:
        ...
        return dot + h_line + [box] + [cam_range]
    ...
    def animate(self, i, counter, dot=None, box=None, h_line=None, fault_c=None, cam_range=None):
        ...
        return dot, box, h_line, cam_range
    ...
    def init_animate(self):
        ...
        self.anim = animation.FuncAnimation(fig, self.iterate, frames=10000, interval=0.1, blit=True,
                                            fargs=(dot, box, h_line, None, cam_range))
